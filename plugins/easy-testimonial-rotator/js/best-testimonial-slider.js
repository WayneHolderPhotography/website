...
;(function($) {
  ...
  $.fn.bxSliderx = function(options) {
    ...
    var initTouch = function() {
      ...
      slider.viewport.on('click', '.bxsliderx a', function(e) {
