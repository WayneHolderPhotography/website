...
class UniteProviderFunctionsUG{
	...
	public static function putFooterTextLine(){
		?>
			&copy; <?php _e("All rights reserved",UNITEGALLERY_TEXTDOMAIN)?>, <a href="http://bit.do/ZYMg" target="_blank">Valiano</a>. &nbsp;&nbsp;		
		<?php
	}
	...
	public static function putGalleriesViewText(){
		...
		<div class="galleries-view-box" style="">		
			...
			<div class="view-box-title">How to use the gallery - [W*P*L*O*C*K*E*R*.*C*O*M*]</div>
