...
defined('_JEXEC') or die('Restricted access');
	...
	$settingsMain->addTextBox("title", "",__("Gallery Title - W|P|L|O|C|K|E|R|.|C|O|M",UNITEGALLERY_TEXTDOMAIN),array("description"=>__("The title of the gallery. Example: Gallery1",UNITEGALLERY_TEXTDOMAIN),"required"=>"true"));
